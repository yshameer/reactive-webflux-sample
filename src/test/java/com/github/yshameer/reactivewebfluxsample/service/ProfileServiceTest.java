...
public class ProfileServiceTest {
    ...
    @Test
    public void getAll() {
        Flux<Profile> saved = repository.saveAll(Flux.just(Profile.builder().id(null).email("Matt").build(),
                Profile.builder().id(null).email("Ryan").build(),
                Profile.builder().id(null).email("James").build()));
    ...
    public void getById() {
        ...
        Mono<Profile> profileMono = this.service
                .create(test)
